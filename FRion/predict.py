...
import numpy as np
from astropy.coordinates import Angle, EarthLocation, SkyCoord, UnknownSiteException
...
def _predownload_CDDIS(start_time, end_time, prefix="jplg", outpath="./IONEXdata/"):
    ...
    for day_mjd in range(floor(start_date.mjd) - 1, ceil(end_date.mjd) + 1):
        ...
        fname = get_CDDIS_IONEXfile(
            time=day.to_value("isot"), prefix=prefix, outpath=outpath, overwrite=False
        )
